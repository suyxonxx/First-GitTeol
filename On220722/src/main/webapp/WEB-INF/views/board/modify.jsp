				...
				<form role="form" action="/board/modify" method="post">
					...
					<div class="form-group">
						<label>Bno</label><input class="form-control" name="bno" readonly="readonly"
							class="form-control" value='<c:out value="${board.bno }" />'><br>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea rows="3" class="form-control" name="content"><c:out
							value="${board.content }" /></textarea><br>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>RegDate</label><input class="form-control" name="regdate" readonly="readonly"
							value='<fmt:formatDate pattern="yyyy/MM/dd" value="${board.regdate }" />'><br>
					</div>
					<div class="form-group">
						<label>UpdateDate</label><input class="form-control" name="updatedate" readonly="readonly"
